...
class Program(models.Model):
    ...
    introduction = models.CharField(_('Program Introduction'), max_length=300, blank=True, null=True)
    teaching_mode = models.CharField(_('Teaching Mode'), max_length=10, choices=TeachingModeChoices.choices, blank=True, null=True)
    teaching_mode_description = models.CharField(_('Teaching Mode Description'), max_length=200, blank=True, null=True)
    academic_history = models.CharField(_('Academic History'), max_length=200, blank=True, null=True)
    advantages = models.CharField(_('Program Advantages'), max_length=2000, blank=True, null=True)
